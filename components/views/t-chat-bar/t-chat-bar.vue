...
.tui-reply-tabbar {
	...
	.tui-chat-tabbar {
		width: 100%;
		background-color: $tui-bg-color-grey;
		display: flex;
		...
		&::after {
			...
			right: 0;
			left: 0;
			border-top: 1rpx solid $tui-text-color-placeholder;
		...
		.tui-chat-input {
			...
			/* #ifndef MP-WEIXIN */
			min-height: 46rpx;
			padding: $tui-spacing-col-base 0;
			/* #endif */
			/* #ifdef MP-WEIXIN */
			min-height: 78rpx;
			/* #endif */
			background-color: $tui-bg-color;
			border-radius: 8rpx;
			margin: 0;
		}
	...
	.tui-reply-more {
		...
		.tui-face-box {
			width: 100%;
			position: relative;
			background-color: $tui-bg-color-hover;

			.tui-face-scroll {
				width: 100%;
				padding: $tui-spacing-row-lg 24rpx 80rpx;
				box-sizing: border-box;
				display: flex;
				flex-wrap: wrap;
			...
			.tui-delete-face_box {
				...
				.tui-delete-keybord {
					...
					align-items: center;
					justify-content: center;
					border-radius: $tui-border-radius-lg;
...
.tui-reply-mask {
	...
	top: 0;
	z-index: 990;
	background-color: $tui-bg-color-mask;
	visibility: hidden;
